...
trajectory simulation with 5000 cells where a single middle group of cells are differentially abundant between conditions.  The methods against which 
...
n.dim <- 15
k <- 30
sim.data <- readRDS("~/Dropbox/Milo/simulations/data/Trajectory_Ncells2000_M3DA_simpleSim.RDS")
...
sim.mylo <- makeNhoods(sim.mylo, k=k, d=n.dim, prop=0.75, refined=TRUE)
