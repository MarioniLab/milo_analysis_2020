...
## Sourcing all the scripts because devtools::load_all kept breaking my session for some reason
source("~/milo/miloR/R/AllClasses.R")
source("~/milo/miloR/R/AllGenerics.R")
source("~/milo/miloR/R/buildGraph.R")
source("~/milo/miloR/R/methods.R")
source("~/milo/miloR/R/milo.R")
